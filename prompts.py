...

{
    ...
    "golden_quote_options": ["开场金句候选（共3条，莎士比亚的风格，深刻且辛辣的断言短句）"],
...
OPENING_IMAGE_STYLES = {
    ...
    "des02": "生成一张质感很好的羊皮纸作为背景，光线较暗。上面用复古的羽毛笔写出'Cody叩底'，这句话最终出现在羊皮纸的左上角位置，字体的大小约为羊皮纸的1/10."
}
...
IMAGE_STYLE_PRESETS = {
    ...
    "style03": "爱德华·霍普的风格，极简摄影作品；三分法构图，巨大的留白，有纵深感、深邃感；字体为素色宋体。", #现代城市孤独感类
